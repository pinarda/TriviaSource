...
hist(allScores$Alex, col=rgb(0,0,1,0.5),
     breaks = seq(from=0.5, to=11.5, by=1), add=T, prob=TRUE)
```
Dad getting a 10 and Ichigo getting a 9 both help a lot, roboAlex has close to an even chance of either score. Note that I truncated all predicted values above 10, assuming this round does not have bonus questions. The behavior seems plausible! With a few tweaks it might be hard to tell human Alex and roboAlex apart...
